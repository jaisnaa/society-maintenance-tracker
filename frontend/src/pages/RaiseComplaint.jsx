...
import { Upload, X, Lightbulb, Camera, MapPin, Clock3 } from "lucide-react";
...
const TIPS = [
  {
    ...
    body: "\"Kitchen sink, 3rd floor\" gets resolved faster than \"the sink is broken.\"",
  },
  {
    icon: Clock3,
    title: "Mention when it started",
    body: "Helps the admin judge urgency and track how long an issue has persisted.",
  },
  {
    icon: Camera,
    title: "A photo speaks volumes",
    body: "Clear, well-lit photos help the maintenance team come prepared with the right tools.",
  },
];
    ...
    <Layout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        <form
          ...
          className="bg-white rounded-xl border border-slate-200 p-6 lg:col-span-2 space-y-5"
        >
          <div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2.5 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent resize-none"
            />
          </div>
          ...
          <div>
            ...
            {preview ? (
              ...
              <label className="flex flex-col items-center justify-center gap-2 w-40 h-40 border-2 border-dashed border-slate-300 rounded-lg cursor-pointer hover:border-blue-500 hover:bg-blue-50/50 transition-colors">
        ...
        <div className="bg-blue-50/60 border border-blue-100 rounded-xl p-5 space-y-5">
